...
class Insets {
  ...
  static double get ssm => 14 * scale;

  static double get l => 17 * scale;
...
class TextStyles {
  ...
  static TextStyle get t1 => lato.regular.size(FontSizes.s16);

  static TextStyle get t2 => lato.semiBold.size(FontSizes.s14);

  static TextStyle get h1 => lato.bold.size(FontSizes.s96);

  static TextStyle get h2 => lato.bold.size(FontSizes.s60);

  static TextStyle get h3 => lato.bold.size(FontSizes.s48);

  static TextStyle get h4 => lato.bold.size(FontSizes.s28);

  static TextStyle get h5 => lato.bold.size(FontSizes.s24);

  static TextStyle get h6 => lato.semiBold.size(FontSizes.s20);

  static TextStyle get h7 => lato.semiBold.size(FontSizes.s18);

  static TextStyle get body1 => lato.regular.size(FontSizes.s16);

  static TextStyle get body2 => lato.regular.size(FontSizes.s14);

  static TextStyle get body3 => lato.size(FontSizes.s12);

  static TextStyle get footnote => lato.regular.size(FontSizes.s10);

  static TextStyle get caption => lato.regular.size(FontSizes.s12);

  static TextStyle get button => lato.light.size(
        FontSizes.s18,
      );
}
